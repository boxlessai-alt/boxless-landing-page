    ...
    <section className="py-20 sm:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <h2 className="font-syne font-bold text-3xl sm:text-4xl text-text-primary text-center mb-12">
          Three steps. <span className="text-accent-plum">Three business days.</span>
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {STEPS.map((s, i) => (
            <div key={i} className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full glass border border-accent-plum/20 mb-4">
                <span className="font-mono font-bold text-2xl text-accent-plum">{s.num}</span>
              </div>
